...
def update_display():
    global text_boxes, win, my_rec, temperature, no_good, new_temp, last_temp
...
def calc_angle():
    ...
    if change < 0:
        color = "red"
    print("change: " + str(change) + "  new temp: " + str(new_temp) + "  last temp: " + str(last_temp))
...
def setup_window():
    ...
    initial_angle = 0  # Arrow points right for 0 change
